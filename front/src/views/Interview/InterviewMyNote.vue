  ...
  <div class="main-container">
    ...
    <div class="info">
      ...
      <p style="margin-top:10px">
        이곳에서는 여러분이 저장한 인터뷰문제를 다시 볼 수 있습니다.
      </p>
      <p style="margin-top:10px">
        연습했던 음성과 해당 음성 파일의 스크립트가 저장되어있습니다.
      </p>
    </div>
    ...
    <span
      ...
      :key="interview.id"
      @click="showDetail(interview.id)"
    >
      <div class="accordion no_highlights" @click="togglePanel">
        {{ interview.p_question }}
      </div>
      <div class="panel">
...
export default {
  ...
  methods: {
    ...
    showDetail(p_id) {
      ...
      axios
        .get(`/api/interprobs/myinters/${this.user_id}/${p_id}/`, {
          headers: headers
        })
        .then(res => {
